...
/* Tuve que correr npm install --save rxjs-compat */
const { mergeMap } = require('rxjs/add/operator/mergeMap');
...
const makeServer = (opts = {}) => {
  ...
  const socketStream = Rx.fromEvent(server, 'connection')
